...
class FrontPage:
    ...
    def register_page(self, canvas: tk.Canvas)-> None:
        ...
        self.__bg_img = self.open_image(r"./Picture/RegisterPage/bg.png", (1000, 800))
        canvas.create_image(0, 0, image=self.__bg_img, anchor='nw')

        self.__text_signup_img = self.open_image(r"./Picture/RegisterPage/text-signup.png", (500, 400))
        canvas.create_image(500, 100, image=self.__text_signup_img)
        
        self.__background_box_img = self.open_image(r"./Picture/RegisterPage/bg-signup.png", (0, 0))
        canvas.create_image(500, 430, image=self.__background_box_img)

        self.__doctor_img = self.open_image(r"./Picture/RegisterPage/doctor.png", (0, 0))
        canvas.create_image(680, 500, image=self.__doctor_img)

        self.__name_text = self.open_image(r"./Picture/RegisterPage/username.png", (250, 200))
        ...
        self.__password_text = self.open_image(r"./Picture/RegisterPage/password.png", (250, 200))
        ...
        self.__address_text = self.open_image(r"./Picture/RegisterPage/Adress.png", (250, 200))
        ...
        self.__submit_img = self.open_image(r"./Picture/RegisterPage/bt-submit.png", (300, 220))
    ...
    def login_system(self, name: str, password: str, canvas: tk.Canvas)-> None:
        ...
        if self.__customer_manage.find_record(self.__customer):
            ...
            self.__medication_page = MedicationPage(window=self.__window, customer=self.__customer)
            self.clear_previous_page(canvas)
    ...
    def login_page(self, canvas: tk.Canvas)-> None:
        ...
        """
        self.clear_previous_page(canvas)
        self.__background_img = self.open_image(r"./Picture/LoginPage/bg-login.png", (1000, 800))
        canvas.create_image(0, 0, anchor="nw", image=self.__background_img)

        self.__text__login_img = self.open_image(r"./Picture/LoginPage/Login.png", (500, 400))
        canvas.create_image(500, 100, image=self.__text__login_img)

        self.__background_box_img = self.open_image(r"./Picture/LoginPage/two-block.png", (0, 0))
        canvas.create_image(500, 430, image=self.__background_box_img)

        self.__doctor_img = self.open_image(r"./Picture/LoginPage/vector-login.png", (0, 0))
        canvas.create_image(295, 585, image=self.__doctor_img)

        self.__name_text = self.open_image(r"./Picture/LoginPage/username.png", (250, 200))
        canvas.create_image(715, 290, image=self.__name_text)
        self.__name_entry = tk.Entry(width=25, border=0, font=("Arial", 18))
        self.__name_entry.place(x=545, y=320, height=50)
        self.__entry_list.append(self.__name_entry)

        self.__password_text = self.open_image(r"./Picture/LoginPage/password.png", (250, 200))
        ...
        self.__submit_img = self.open_image(r"./Picture/LoginPage/submit.png", (300, 220))
        self.__submit_login_btn = tk.Button(image=self.__submit_img,
                                            border=0, height=70, width=200, padx=0, pady=0,
                                            bg="#F1E5CD",
                                            command=lambda: self.login_system(self.__name_entry.get()
                                                                           , self.__password_entry.get(), canvas))
        self.__submit_login_btn.place(x=600, y=560)
        self.__button_list.append(self.__submit_login_btn)

        self.__admin_img = self.open_image(r"./Picture/LoginPage/Bt-loginAdmin.png", (300, 230))
    ...
    def welcome_page(self, canvas: tk.Canvas)-> None:
        ...
        Returns:None."""
        self.clear_previous_page(canvas)
        self.__bg_img = self.open_image(r"./Picture/WelcomePage/h-bg.png", (1000, 800))
        canvas.create_image(0, 0, image=self.__bg_img, anchor="nw")

        self.__welcome_txt = self.open_image(r"./Picture/WelcomePage/h-text-wel.png", (650, 550))
        canvas.create_image(510, 110, image=self.__welcome_txt)

        self.__doctor = self.open_image(r"./Picture/WelcomePage/h-pic.png", (500, 400))
        canvas.create_image(500, 350, image=self.__doctor)

        self.__login_img = self.open_image(r"./Picture/WelcomePage/hbt-login.png", (300, 220))
        ...
        self.__signup_img = self.open_image(r"./Picture/WelcomePage/bt-signup.png", (170, 140))
    ...
    def admin_login_page(self, canvas:tk.Canvas)->None:
        ...
        self.__admin_bg_img = self.open_image(r"./Picture/AdminLoginPage/bg-admin-login.png", (0, 0))
        canvas.create_image(0, 0, image=self.__admin_bg_img, anchor="nw")

        self.__cartoon = self.open_image(r"./Picture/AdminLoginPage/vector-cartoon.png", (950, 800))
        canvas.create_image(250, 450, image=self.__cartoon)

        self.__login_text = self.open_image(r"./Picture/AdminLoginPage/text-admin-login.png", (450, 350))
        canvas.create_image(710, 150, image=self.__login_text)

        self.__rectangle = self.open_image(r"./Picture/AdminLoginPage/rectangle.png", (700, 500))
        canvas.create_image(720, 500, image=self.__rectangle)

        self.__welcome_txt = self.open_image(r"./Picture/AdminLoginPage/text-welcome.png", (350, 250))
        canvas.create_image(710, 350, image=self.__welcome_txt)

        self.__admin_name_entry = tk.Entry(width=20, border=0, font=("Arial", 18))
        self.__admin_name_entry.place(x=620, y=400, height=50)
        self.__entry_list.append(self.__admin_name_entry)
        self.__name_logo = self.open_image(r"./Picture/AdminLoginPage/usernamelogo.png", (60, 50))
        canvas.create_image(580, 425, image=self.__name_logo)

        self.__admin_password_entry = tk.Entry(width=20, border=0, font=("Arial", 18), show="*")
        self.__admin_password_entry.place(x=620, y=500, height=50)
        self.__entry_list.append(self.__admin_password_entry)
        self.__password_logo = self.open_image(r"./Picture/AdminLoginPage/passwordlogo.png", (60, 50))
        canvas.create_image(580, 525, image=self.__password_logo)

        self.__login_btn_img = self.open_image(r"./Picture/AdminLoginPage/login.png", (300, 220))
        self.__login_btn = tk.Button(image=self.__login_btn_img, background="#000", border=0, width=250,
                                        height=70, command=lambda: self.admin_login_system(self.__admin_name_entry.get()
                                                                                             , self.__admin_password_entry.get(), canvas),
